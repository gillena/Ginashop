    ...
    <div class="container-fluid ">
        <form method="POST" enctype="multipart/form-data">
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="form-input">
                            ...
                            <div class="mb-5 row align-items-center">
                                <label class="form-label-title col-sm-3 mb-0">Tên cửa hàng<span class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <input name="name" class="form-control input-text" value="<?= $dataStoreCustom['name'] ?? '' ?>" type="text" placeholder="Tên cửa hàng" required>
                                </div>
                            </div>
                            <!--  -->
                            ...
                            <div class="mb-5 row align-items-center">
                                <label class="form-label-title col-sm-3 mb-0">Logo cửa hàng<span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                ...
                <div class="col-sm-12 m-auto ">
                    <div class="card">
                        ...
                        <div class="form-input">
                            ...
                            <div class="mb-5 row align-items-center">
                                <label class="form-label-title col-sm-3 mb-0">Hình ảnh nền<span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    <input name="background_image" class="form-control input-file" type="file" >
                                </div>

                                <div class="col-sm-3">
                                    <img class="img-review" src="<?= $dataBanner['background_image'] ?? '' ?>" alt="<?= 'background image ' . $dataBanner['title'] ?? '' ?>">
                                </div>
                            </div>
                            <!--  -->
                ...
                <button id="btn_ele" class="btn btn-custom col-sm-8 m-auto ">Cập nhật thông tin cửa hàng <span class="spin"><i class="fas fa-spinner"></i></span></button>
            </div>
        </form>
    </div>
</section>
