                ...
                <?php if (!in_array($order_status_id, [3, 4, 5])) : ?>
                    <div class="col-xl-4 ms-auto">
                        <div class="update-status">
                            <button data-bs-toggle="modal" data-bs-target="#updateModal" class="btn btn-custom">Cập nhật trạng thái đơn hàng</button>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content py-3">
            <div class="modal-header border-0  d-block text-center">
                <h5 class="modal-title w-100 mb-5 fs-1 ">Cập nhật trạng thái đơn hàng</h5>
                ...
                <div class="modal-body add-wrap-admin">
                    <div class="form-input"> 
                        ...
                        <div class="mb-5 row align-items-center">
                            <label class="form-label-title col-sm-3 mb-0">Trạng thái đơn hàng</label>
                            <div class="col-sm-9">
