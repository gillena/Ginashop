                ...
                <div class="col-sm-8 m-auto ">
                    <div class="card">
                        ...
                        <div class="form-input">
                            ...
                            <div class="mb-5 row align-items-center">
                                <label class="form-label-title col-sm-3 mb-0">URL Mô Hình VR</label>
                                <div class="col-sm-9">
                                <input class="form-control input-text" value="<?= htmlspecialchars($dataValueOld['vr_model_url'] ?? '') ?>" name="vr_model_url" type="url" placeholder="URL sản phẩm">
                                </div>
                            </div>
