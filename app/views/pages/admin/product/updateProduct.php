    ...
    <div class="container-fluid ">
        <form method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-sm-8 m-auto ">
                    <div class="card">
                        ...
                        <div class="form-input">
                            ...
                            <!-- New URL Field -->
                            <div class="mb-5 row align-items-center">
                                <label class="form-label-title col-sm-3 mb-0">URL sản phẩm</label>
                                <div class="col-sm-9">
                                    <input class="form-control input-text" value="<?= htmlspecialchars($dataProd['vr_model_url'] ?? '') ?>" name="vr_model_url" type="url" placeholder="URL sản phẩm">
                                </div>
                            </div>
                ...
                <button id="btn_ele" class="btn btn-custom col-sm-8 m-auto">Cập nhật sản phẩm <span class="spin"><i class="fas fa-spinner"></i></span></button>
            </div>
