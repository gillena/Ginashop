                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            ?>
                                    <td class="td-category" style="color: #000 !important;"><?= $cateItem['name'] ?></td>
                            <?php }
                            } ?>
                            ...
                            ?>
                                   <td class="td-category" style="color: #000 !important;"><?= $brandItem['name'] ?></td>
                            ...
                            <td>
                                <div class="options">
                                    <li class="m-0 ">
                                        <a class="text-decoration-underline text-primary" href="admin/product-variants/<?= $product['id'] ?>">
                                        Chi tiết
                                        </a>
                                    </li>
                                </div>
