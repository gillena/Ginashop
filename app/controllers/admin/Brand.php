...
class Brand extends Controller
{
    ...
    function addBrand()
    {
        ...
        // Kiem tra da co thuong hieu da ton tai chua
    ...
    function updateBrand()
    {
        ...
        if (!$success) {
            return $this->res->setToastSession($type, 'Cập nhật thất bại.', 'admin/brand');
        }

        return $this->res->setToastSession('success', 'Cập nhật thành công.', 'admin/brand');
    }
