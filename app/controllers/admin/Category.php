...
class Category extends Controller
{
    ...
    function updateCategory($id)
    {
        ...
        if ($updateCategory) {
            return $this->res->setToastSession('success', 'Cập nhật thành công.', 'admin/category');;
        } else {
    ...
    {
        if (!$this->req->isPost()) {
            return $this->res->setToastSession('success', 'Có lỗi xảy ra vui lòng thử lại.', 'admin/news');;
        }
