...
class User extends Controller
{
    ...
    private function checkRoleAdmin()
    {
        ...
        //check accessToken con han khong
    ...
    function updateUser($id)
    {
        ...
        if ($updateUser) {
            return $this->res->setToastSession('success', 'Cập nhật thành công.', 'admin/user');;
        } else {
            $this->Toast($type, 'Cập nhật thất bại vui lòng thử lại.');
            return $this->renderUpdatePage($dataUserUp, $dataRole);
        }
    }
    ...
    function changeIsBlock()
    {
        if ($this->req->isPost()) {
            ...
            if ($update) {
                ...
                echo json_encode(['success' => 'Cập nhật thất bại.']);
                return;
            }
        }
        return json_encode([]);
